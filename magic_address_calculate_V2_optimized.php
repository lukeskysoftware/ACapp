...
function checkAvailableSlotsNearAppointment($appointmentData, $buffer_minutes = 60) {
    ...
    $proposed_before_day_of_week = date('l', strtotime($proposed_before_date_str)); // Es: "Monday", "Tuesday", ecc.
    ...
    // Check 1: Rispetto ai limiti di slot per il giorno della settimana del slot proposto
    $proposed_after_day_of_week = date('l', strtotime($proposed_after_date_str)); // Es: "Monday", "Tuesday", ecc.
